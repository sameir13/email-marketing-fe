...
<form>
    <div className="relative flex w-full border border-white-dark/20">
        <button type="submit" placeholder="Let's find your question in fast way" className="flex items-center justify-center p-3 m-auto text-primary">
            <svg>...</svg>
        </button>
        <input
            type="text"
        ...
        />
                ...
                >
                    <div className="mb-5 space-y-5">
                        <form>
                            <div className="relative flex w-full border border-white-dark/20">
                                <button  className="flex items-center justify-center p-3 m-auto text-primary">
                                    <IconSearch className="w-5 h-5 mx-auto" />
                                </button>
                                <input
                                    type="text"
                                    placeholder="Let's find your question in fast way"
