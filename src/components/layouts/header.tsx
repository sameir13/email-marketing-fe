                ...
                <ul className="horizontal-menu hidden border-t border-[#ebedf2] bg-white px-6 py-1.5 font-semibold text-black rtl:space-x-reverse dark:border-[#191e3a] dark:bg-black dark:text-white-dark lg:space-x-1.5 xl:space-x-8">
                    ...
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <Link href="/apps/todolist">Todo List</Link>
                            </li>
                            <li>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">Datatables</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                    ...
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <Link href="/forms/checkbox-radio">Checkbox & Radio</Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link href="/forms/date-picker">Date & Range Picker</Link>
                            </li>
                            <li>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">Users</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                    ...
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <Link href="/pages/contact-us-boxed">Contact Us Boxed</Link>
                            </li>
                            <li>
                                <Link href="/pages/contact-us-cover">Contact Us Cover</Link>
                            </li>
                            <li>
                                <Link href="/pages/faq">FAQ</Link>
                            </li>
                            <li>
                                <Link href="/pages/coming-soon-boxed">Coming Soon Boxed</Link>
                            </li>
                            <li>
                                <Link href="/pages/coming-soon-cover">Coming Soon Cover</Link>
                            </li>
                            <li>
                                <Link href="/pages/maintenence">Maintenance</Link>
                            </li>
                            <li className="relative">
                                <button type="button">
                                    Error
                                ...
                                <ul className="absolute top-0 z-[10] hidden min-w-[180px] rounded bg-white p-0 py-2 text-dark shadow ltr:left-[95%] rtl:right-[95%] dark:bg-[#1b2e4b] dark:text-white-dark">
                                    <li>
                                        <Link href="/pages/error404">404</Link>
                                    </li>
                                    <li>
                                        <Link href="/pages/error500">500</Link>
                                    </li>
                                    <li>
                                        <Link href="/pages/error503">503</Link>
                                    </li>
                                </ul>
                            </li>
                            <li className="relative">
                                ...
                                <ul className="absolute top-0 z-[10] hidden min-w-[180px] rounded bg-white p-0 py-2 text-dark shadow ltr:left-[95%] rtl:right-[95%] dark:bg-[#1b2e4b] dark:text-white-dark">
                                    <li>
                                        <Link href="/auth/cover-login">Login Cover</Link>
                                    </li>
                                    <li>
                                        <Link href="/auth/boxed-signin">Login Boxed</Link>
                                    </li>
                                </ul>
                            </li>
                            <li className="relative">
                                ...
                                <ul className="absolute top-0 z-[10] hidden min-w-[180px] rounded bg-white p-0 py-2 text-dark shadow ltr:left-[95%] rtl:right-[95%] dark:bg-[#1b2e4b] dark:text-white-dark">
                                    <li>
                                        <Link href="/auth/cover-register">Register Cover</Link>
                                    </li>
                                    <li>
                                        <Link href="/auth/boxed-signup">Register Boxed</Link>
                                    </li>
                                </ul>
                            </li>
                            <li className="relative">
                                ...
                                <ul className="absolute top-0 z-[10] hidden min-w-[180px] rounded bg-white p-0 py-2 text-dark shadow ltr:left-[95%] rtl:right-[95%] dark:bg-[#1b2e4b] dark:text-white-dark">
                                    <li>
                                        <Link href="/auth/cover-password-reset">Recover ID Cover</Link>
                                    </li>
                                    <li>
                                        <Link href="/auth/boxed-password-reset">Recover ID Boxed</Link>
                                    </li>
                                </ul>
                            </li>
                            <li className="relative">
                                ...
                                <ul className="absolute top-0 z-[10] hidden min-w-[180px] rounded bg-white p-0 py-2 text-dark shadow ltr:left-[95%] rtl:right-[95%] dark:bg-[#1b2e4b] dark:text-white-dark">
                                    <li>
                                        <Link href="/auth/cover-lockscreen">Unlock Cover</Link>
                                    </li>
                                    <li>
                                        <Link href="/auth/boxed-lockscreen">Unlock Boxed</Link>
                                    </li>
                                </ul>
                            </li>
                        </ul>
